...
public class GripperConstants {
    ...
    public enum GripperState {
        ...
        COLLECT_ALGAE_FROM_LOLLIPOP(Rotation2d.fromDegrees(-10), -50, 1),
        ...
        PREPARE_FOR_SCORING_ALGAE_IN_PROCESSOR(Rotation2d.fromDegrees(0), COLLECT_ALGAE_FROM_REEF.targetGripperVoltage, 0.3),
