...
public class ElevatorConstants {
    ...
    static final Pose3d SECOND_STAGE_VISUALIZATION_ORIGIN_POINT = new Pose3d(-0.120, 0, 0.1111, new Rotation3d(edu.wpi.first.math.util.Units.degreesToRadians(0), 0, 0));
