...
public class GearRatioCalculationCommand extends Command {
     ...
     * When you have backlash and want to account for it with a measuring delay, use {@link org.trigon.commands.GearRatioCalculationCommand#GearRatioCalculationCommand(TalonFXMotor, CANcoderEncoder, double, SubsystemBase)}.
     *
     ...
     * When you have backlash and want to account for it with a measuring delay, use {@link org.trigon.commands.GearRatioCalculationCommand#GearRatioCalculationCommand(DoubleSupplier, DoubleSupplier, DoubleConsumer, double, SubsystemBase)}.
     *
