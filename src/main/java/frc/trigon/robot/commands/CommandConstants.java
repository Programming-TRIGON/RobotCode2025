...
public class CommandConstants {
    ...
    public static final Command
            ...
            SET_TARGET_REEF_CLOCK_POSITION_0_OCLOCK_COMMAND = new InstantCommand(() -> CoralPlacingCommands.CURRENT_REEF_CLOCK_POSITION = FieldConstants.ReefClockPosition.REEF_0_OCLOCK).ignoringDisable(true),
