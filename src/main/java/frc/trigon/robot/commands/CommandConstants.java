...
public class CommandConstants {
    ...
    public static final Command
            ...
            SET_TARGET_SCORING_REEF_LEVEL_L1_CORAL_INTAKE_COMMAND = new InstantCommand(() -> CoralPlacingCommands.TARGET_SCORING_LEVEL = CoralPlacingCommands.ScoringLevel.L1_CORAL_INTAKE).ignoringDisable(true),
