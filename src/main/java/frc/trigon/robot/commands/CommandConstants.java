...
public class CommandConstants {
    ...
    public static final Command
            ...
            SET_TARGET_SCORING_REEF_LEVEL_L1_ELEVATOR_COMMAND = new InstantCommand(() -> CoralPlacementCommands.TARGET_SCORING_LEVEL = CoralPlacementCommands.ScoringLevel.L1_ELEVATOR).ignoringDisable(true),
            SET_TARGET_SCORING_REEF_LEVEL_L1_CORAL_INTAKE_COMMAND = new InstantCommand(() -> CoralPlacementCommands.TARGET_SCORING_LEVEL = CoralPlacementCommands.ScoringLevel.L1_CORAL_INTAKE).ignoringDisable(true),
