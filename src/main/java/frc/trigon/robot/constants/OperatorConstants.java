...
public class OperatorConstants {
    ...
    public static final Trigger
            ...
            COLLECT_CORAL_FROM_GROUND_TRIGGER = DRIVER_CONTROLLER.leftTrigger(),
            COLLECT_ALGAE_TRIGGER = DRIVER_CONTROLLER.leftBumper(),
            TOGGLE_CORAL_ALIGNMENT_TRIGGER = OPERATOR_CONTROLLER.o();
}