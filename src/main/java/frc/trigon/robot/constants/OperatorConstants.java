...
public class OperatorConstants {
    ...
    public static final Trigger
            ...
            LEFT_MULTIFUNCTION_TRIGGER = DRIVER_CONTROLLER.leftStick().or(OPERATOR_CONTROLLER.m()),
            RIGHT_MULTIFUNCTION_TRIGGER = DRIVER_CONTROLLER.rightStick().or(OPERATOR_CONTROLLER.l()),
            ...
            COLLECT_ALGAE_TRIGGER = OPERATOR_CONTROLLER.a().or(DRIVER_CONTROLLER.a()),
            FEEDER_CORAL_COLLECTION_WITH_GRIPPER = OPERATOR_CONTROLLER.d(),
            SCORE_IN_NET_TRIGGER = OPERATOR_CONTROLLER.n().or(DRIVER_CONTROLLER.b()),
    ...
    public static final Trigger
            ...
            SET_TARGET_SCORING_REEF_LEVEL_L3_TRIGGER = OPERATOR_CONTROLLER.numpad2().or(DRIVER_CONTROLLER.povUp()),
            SET_TARGET_SCORING_REEF_LEVEL_L4_TRIGGER = OPERATOR_CONTROLLER.numpad3().or(DRIVER_CONTROLLER.povRight()),
            ...
            ENABLE_IGNORE_LOLLIPOP_CORAL_TRIGGER = OPERATOR_CONTROLLER.minus(),
            DISABLE_IGNORE_LOLLIPOP_CORAL_TRIGGER = OPERATOR_CONTROLLER.equals();
}