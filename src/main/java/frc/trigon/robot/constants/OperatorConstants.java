...
public class OperatorConstants {
    ...
    public static final Trigger
            ...
            OVERRIDE_AUTONOMOUS_FUNCTIONS_TRIGGER = DRIVER_CONTROLLER.leftStick(),
            ...
            FEEDER_CORAL_COLLECTION_TRIGGER = OPERATOR_CONTROLLER.f().or(DRIVER_CONTROLLER.back()),
            ...
            CLIMB_TRIGGER = OPERATOR_CONTROLLER.w(),
            OVERRIDE_IS_CLIMBING_TRIGGER = OPERATOR_CONTROLLER.m(),
            MANUALLY_RAISE_CLIMBER_TRIGGER = OPERATOR_CONTROLLER.f1(),
            MANUALLY_LOWER_CLIMBER_TRIGGER = OPERATOR_CONTROLLER.f2(),
            EJECT_CORAL_TRIGGER = OPERATOR_CONTROLLER.e().or(DRIVER_CONTROLLER.x()),
            DEBUGGING_TRIGGER = OPERATOR_CONTROLLER.one(),
            UNLOAD_CORAL_TRIGGER = OPERATOR_CONTROLLER.z().or(DRIVER_CONTROLLER.rightStick()),
