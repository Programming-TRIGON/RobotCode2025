...
public class OperatorConstants {
    ...
    public static final Trigger
            ...
            COLLECT_CORAL_FROM_FEEDER_TRIGGER = DRIVER_CONTROLLER.leftTrigger(),
            COLLECT_CORAL_FROM_GROUND_TRIGGER = DRIVER_CONTROLLER.leftBumper(),
            COLLECT_ALGAE_TRIGGER = DRIVER_CONTROLLER.rightTrigger();
}