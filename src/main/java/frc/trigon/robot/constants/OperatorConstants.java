...
public class OperatorConstants {
    ...
    public static final Trigger
            ...
            CONTINUE_SCORING_TRIGGER = OPERATOR_CONTROLLER.k().or(DRIVER_CONTROLLER.leftBumper()),
            EJECT_CORAL_TRIGGER = OPERATOR_CONTROLLER.e(),
            DEBUGGING_TRIGGER = OPERATOR_CONTROLLER.one(),
            UNLOAD_CORAL = OPERATOR_CONTROLLER.z();
    ...
    public static final Trigger
            ...
            SET_TARGET_SCORING_REEF_LEVEL_L1_ELEVATOR_TRIGGER = OPERATOR_CONTROLLER.numpadDecimal(),
            SET_TARGET_SCORING_REEF_LEVEL_L1_CORAL_INTAKE_TRIGGER = OPERATOR_CONTROLLER.numpad0(),
