...
public class PathPlannerConstants {
    public static final PathConstraints DRIVE_TO_REEF_CONSTRAINTS = new PathConstraints(3.2, 3.6, Units.degreesToRadians(450), Units.degreesToRadians(900));
    ...
    public static final double FEEDFORWARD_SCALAR = 0.7;
