...
public class SimulatedGamePieceConstants {
    ...
    private static final Rotation3d
            CORAL_TO_L2_AND_L3_POSITION_ROTATION = new Rotation3d(0, Units.degreesToRadians(35), 0),
    ...
    public static final Pose3d[]
            ...
            new Pose3d(-4.938, -0.164, L2_SCORE_HEIGHT_METERS, CORAL_TO_L2_AND_L3_POSITION_ROTATION).relativeTo(FIELD_CENTER),
            new Pose3d(-4.938, 0.164, L2_SCORE_HEIGHT_METERS, CORAL_TO_L2_AND_L3_POSITION_ROTATION).relativeTo(FIELD_CENTER),
            new Pose3d(-4.753, -0.483, L2_SCORE_HEIGHT_METERS, CORAL_TO_L2_AND_L3_POSITION_ROTATION.rotateBy(CORAL_4_OCLOCK_ROTATION)).relativeTo(FIELD_CENTER),
            new Pose3d(-4.753, 0.483, L2_SCORE_HEIGHT_METERS, CORAL_TO_L2_AND_L3_POSITION_ROTATION.rotateBy(CORAL_8_OCLOCK_ROTATION)).relativeTo(FIELD_CENTER),
            new Pose3d(-4.469, -0.648, L2_SCORE_HEIGHT_METERS, CORAL_TO_L2_AND_L3_POSITION_ROTATION.rotateBy(CORAL_4_OCLOCK_ROTATION)).relativeTo(FIELD_CENTER),
            new Pose3d(-4.469, 0.648, L2_SCORE_HEIGHT_METERS, CORAL_TO_L2_AND_L3_POSITION_ROTATION.rotateBy(CORAL_8_OCLOCK_ROTATION)).relativeTo(FIELD_CENTER),
            new Pose3d(-4.1, -0.647, L2_SCORE_HEIGHT_METERS, CORAL_TO_L2_AND_L3_POSITION_ROTATION.rotateBy(CORAL_2_OCLOCK_ROTATION)).relativeTo(FIELD_CENTER),
            new Pose3d(-4.1, 0.647, L2_SCORE_HEIGHT_METERS, CORAL_TO_L2_AND_L3_POSITION_ROTATION.rotateBy(CORAL_10_OCLOCK_ROTATION)).relativeTo(FIELD_CENTER),
            new Pose3d(-3.816, -0.484, L2_SCORE_HEIGHT_METERS, CORAL_TO_L2_AND_L3_POSITION_ROTATION.rotateBy(CORAL_2_OCLOCK_ROTATION)).relativeTo(FIELD_CENTER),
            new Pose3d(-3.816, 0.484, L2_SCORE_HEIGHT_METERS, CORAL_TO_L2_AND_L3_POSITION_ROTATION.rotateBy(CORAL_10_OCLOCK_ROTATION)).relativeTo(FIELD_CENTER),
            new Pose3d(-3.632, -0.164, L2_SCORE_HEIGHT_METERS, CORAL_TO_L2_AND_L3_POSITION_ROTATION.rotateBy(CORAL_12_OCLOCK_ROTATION)).relativeTo(FIELD_CENTER),
            new Pose3d(-3.632, 0.164, L2_SCORE_HEIGHT_METERS, CORAL_TO_L2_AND_L3_POSITION_ROTATION.rotateBy(CORAL_12_OCLOCK_ROTATION)).relativeTo(FIELD_CENTER),
    },
            L3_LOCATIONS = new Pose3d[]{
                    new Pose3d(-4.938, -0.164, L3_SCORE_HEIGHT_METERS, CORAL_TO_L2_AND_L3_POSITION_ROTATION).relativeTo(FIELD_CENTER),
                    new Pose3d(-4.938, 0.164, L3_SCORE_HEIGHT_METERS, CORAL_TO_L2_AND_L3_POSITION_ROTATION).relativeTo(FIELD_CENTER),
                    new Pose3d(-4.753, -0.483, L3_SCORE_HEIGHT_METERS, CORAL_TO_L2_AND_L3_POSITION_ROTATION.rotateBy(CORAL_4_OCLOCK_ROTATION)).relativeTo(FIELD_CENTER),
                    new Pose3d(-4.753, 0.483, L3_SCORE_HEIGHT_METERS, CORAL_TO_L2_AND_L3_POSITION_ROTATION.rotateBy(CORAL_8_OCLOCK_ROTATION)).relativeTo(FIELD_CENTER),
                    new Pose3d(-4.469, -0.648, L3_SCORE_HEIGHT_METERS, CORAL_TO_L2_AND_L3_POSITION_ROTATION.rotateBy(CORAL_4_OCLOCK_ROTATION)).relativeTo(FIELD_CENTER),
                    new Pose3d(-4.469, 0.648, L3_SCORE_HEIGHT_METERS, CORAL_TO_L2_AND_L3_POSITION_ROTATION.rotateBy(CORAL_8_OCLOCK_ROTATION)).relativeTo(FIELD_CENTER),
                    new Pose3d(-4.1, -0.647, L3_SCORE_HEIGHT_METERS, CORAL_TO_L2_AND_L3_POSITION_ROTATION.rotateBy(CORAL_2_OCLOCK_ROTATION)).relativeTo(FIELD_CENTER),
                    new Pose3d(-4.1, 0.647, L3_SCORE_HEIGHT_METERS, CORAL_TO_L2_AND_L3_POSITION_ROTATION.rotateBy(CORAL_10_OCLOCK_ROTATION)).relativeTo(FIELD_CENTER),
                    new Pose3d(-3.816, -0.484, L3_SCORE_HEIGHT_METERS, CORAL_TO_L2_AND_L3_POSITION_ROTATION.rotateBy(CORAL_2_OCLOCK_ROTATION)).relativeTo(FIELD_CENTER),
                    new Pose3d(-3.816, 0.484, L3_SCORE_HEIGHT_METERS, CORAL_TO_L2_AND_L3_POSITION_ROTATION.rotateBy(CORAL_10_OCLOCK_ROTATION)).relativeTo(FIELD_CENTER),
                    new Pose3d(-3.632, -0.164, L3_SCORE_HEIGHT_METERS, CORAL_TO_L2_AND_L3_POSITION_ROTATION.rotateBy(CORAL_12_OCLOCK_ROTATION)).relativeTo(FIELD_CENTER),
                    new Pose3d(-3.632, 0.164, L3_SCORE_HEIGHT_METERS, CORAL_TO_L2_AND_L3_POSITION_ROTATION.rotateBy(CORAL_12_OCLOCK_ROTATION)).relativeTo(FIELD_CENTER),
            },
