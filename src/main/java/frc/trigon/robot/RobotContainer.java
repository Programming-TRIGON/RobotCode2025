...
public class RobotContainer {
    ...
    private void bindSetters() {
        OperatorConstants.ENABLE_CORAL_ALIGNMENT_TRIGGER.onTrue(CommandConstants.ENABLE_AUTO_CORAL_INTAKE_COMMAND);
        OperatorConstants.DISABLE_CORAL_ALIGNMENT_TRIGGER.onTrue(CommandConstants.DISABLE_AUTO_CORAL_INTAKE_COMMAND);
